...
//         console.log(str.charAt(i)); //or console.log(str[i])
//     }
//
// }
//
...
var writeOut = function (input) {
    for (var i=0; i<input.length; i++){
        console.log(input[i] + " is a beautiful city");
    }
}

var visitCity = function(city) {
    console.log("Have you been to " +  city + "?");
}

var cities = ["Warsaw", "Paris", "New York", "San Antonio", "Berlin"];
